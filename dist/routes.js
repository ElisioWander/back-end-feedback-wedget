...
const presma_feedbacks_repository_1 = require("./repositories/prisma/presma-feedbacks-repository");
...
exports.routes.post("/feedbacks", async (req, res) => {
    ...
    const prismaFeedbacksRepository = new presma_feedbacks_repository_1.PrismaFeedbacksRepository();
